...
Telegram-бот для перевірки знань студентів у форматі вікторини з вибором однієї правильної відповіді. Призначений як інструмент експрес-самоконтролю в коледжі: студент обирає дисципліну, бот по одному надсилає випадкові питання з підготовленої бази, фіксує результат і веде статистику.

Це дипломна робота фахового молодшого бакалавра з інженерії програмного забезпечення. Архітектура коду відповідає тій, що описана в пояснювальній записці.
...
- Усі тексти, що бачить користувач, — українською мовою.
